...
$free = get_field('free') ;
$cookie = $_COOKIE['formulario_enviado'];
$user_id = get_current_user_id();
if ( $user_id ) {
    // Obtener los planes de membresía del usuario
...
if( $free && !$usuario_pago && !$cookie  ) :
include ('part-popup.php');
endif; 


if ( !$free && !$usuario_pago  ) :
	get_template_part( 'part', 'memberships' );
else :
?>
<main>
    <div class="py-8 md:py-24">
        <div class="container">
            <div class="max-w-[46rem]">
                ...
                <div class="my-8 text-xl md:my-12 md:text-2xl"><?php the_excerpt(); ?></div>
                <!--
                <svg class="w-20 fill-current" viewBox="0 0 24 24">
    ...
    <div class="bg-white py-8 text-neutral-800 md:py-24">
        <div class="container">
            ...
            <button class="button bg-orange-500 text-white">continue discovering</button>
        </div>
    </div>

    <div class="overflow-hidden py-8 md:py-24">
        <div class="container">
            <h2 class="mb-8 text-4xl lowercase md:mb-12">you also might be interested in</h2>
            <div class="relative">
                <div class="swiper">
                    <div class="swiper-wrapper">
                        <?php foreach ( get_posts( array( 'posts_per_page' => 6 ) ) as $post ) : ?>
                        <?php setup_postdata( $post ); ?>
                        <div class="swiper-slide">
                            <div class="mb-4 border border-current p-8">
                                <h3><?php the_title(); ?></h3>
                                <svg class="mt-4 w-20 fill-current" viewBox="0 0 24 24">
                                    <?php if ( has_post_format('link') ) : ?>
                                    <path
                                        d="M18.69 2.3v1.92h-1.92V2.3h1.92ZM16.4 0v1.92h-1.9V0h1.91ZM6.76 6.9v1.9H4.85V6.9h1.91ZM21 6.9v1.9h-1.92V6.9H21ZM4.93 0v1.92H3V0h1.92ZM9.5 2.3v1.92H7.6V2.3h1.9Zm2.3 2.3v1.9H9.88V4.6h1.92Zm0-2.29v1.92H9.88V2.3h1.92ZM9.5 0v1.92H7.6V0h1.9Zm4.59 4.59V6.5h-1.92V4.6h1.92ZM7.21 0v1.92H5.29V0h1.92Zm6.43 11.48v1.91h-1.92v-1.91h1.92Zm-4.6 1.68v1.92h-1.9v-1.92h1.9Zm0-3.97v1.92h-1.9V9.19h1.9Zm8.27 11.35v-.02c0-.1.09-.2.2-.2h3.19l-3.39 3.41v-3.2Zm-.98-11.35h4.62v10.77H17.5a.58.58 0 0 0-.58.58V24H4.17a.2.2 0 0 1-.2-.2V13.17h2.78v2.11c0 .1.08.18.18.18h2.32c.1 0 .19-.08.19-.18v-1.5h6.7c.1 0 .19-.08.19-.18V9.19Zm2.36-4.6V6.5h-1.92V4.6h1.92Zm-7.36 6.89v1.91h-1.9v-1.91h1.9Zm4.59-2.29v1.92h-1.9V9.19h1.9Zm0 2.29v1.91h-1.9v-1.91h1.9Z" />
                                    <?php elseif ( has_post_format('status') ) : ?>
                            ...
                            <a class="button w-full bg-white text-neutral-800"
                                href="<?php the_permalink(); ?>"><?php echo esc_html( get_the_category()[0]->name ); ?></a>
                        </div>
                        <?php endforeach; ?>
                        <?php wp_reset_postdata(); ?>
                    </div>
                </div>
                <button class="swiper-prev absolute -left-6 bottom-1/2 w-8 md:-left-12">
                    <svg class="fill-current" viewBox="0 0 24 24">
                        <path
                            d="M24 11.4v1.2H2.01l7.78 7.82-.84.83-8.78-8.83A.6.6 0 0 1 .6 11.4H24ZM5.4 8l-.84-.83 4.39-4.42.84.83L5.4 8Z" />
                    </svg>
                </button>
                <button class="swiper-next absolute -right-6 bottom-1/2 w-8 md:-right-12">
                    <svg class="fill-current" viewBox="0 0 24 24">
                        <path
...
<!--
<div id="popup" class="fixed right-0 top-32 z-10 w-96 bg-violet-700 p-8 transition-all duration-300 xl:p-12">
    <button class="close-popup mb-8 ml-auto block w-6">
        <svg class="fill-current" viewBox="0 0 24 24">
            <path
                d="M13.15 12 24 22.85 22.85 24 12 13.15 1.15 24 0 22.85 22.85 0 24 1.15 13.15 12ZM0 1.15 1.15 0l7.34 7.35-1.14 1.14L0 1.15Z" />
        </svg>
    </button>
    <p>
        enjoy the content for free in the next two weeks. more to come in January with a possibility to upgrade
    </p>
    <a class="button mt-8 bg-orange-500" href="<?php the_permalink( 46 ); ?>">
        <span>Upgrade now</span>
        <svg class="ml-4 w-7 fill-current" viewBox="0 0 24 24">
            <path
                d="M0 12.6v-1.2h21.99l-7.78-7.82.84-.83 8.78 8.83a.6.6 0 0 1-.42 1.01H0ZM18.6 16l.84.83-4.39 4.42-.84-.83L18.6 16Z" />
        </svg>
    </a>
